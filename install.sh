...
printf "${DIM}  Minimalist harness for the Red Hat ecosystem${RESET}\n"
echo ""
...
printf "    • A custom model server already running\n"
printf "      ${DIM}(e.g. Ollama, vLLM, MaaS, etc.)${RESET}\n"
echo ""
...
printf "      and are ${BOLD}never${RESET} sent anywhere or baked into the image\n"
